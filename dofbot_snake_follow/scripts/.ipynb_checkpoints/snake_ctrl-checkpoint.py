...
class snake_ctrl:
    ...
    # def get_Posture(self):
        ...
        # request.cur_joint1 = self.cur_joint[1 - 1]
        # request.cur_joint2 = self.cur_joint[2 - 1]
        # request.cur_joint3 = self.cur_joint[3 - 1]
        # request.cur_joint4 = self.cur_joint[4 - 1]
        # request.cur_joint5 = self.cur_joint[5 - 1]
        request.kin_name = "fk"
